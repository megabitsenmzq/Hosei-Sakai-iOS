...
#Preview {
    TimetableContentView(table: [["", "", "", "", "", "", ""], ["", "", "プロジェクト実習・制作２", "プロジェクト実習・制作２", "", "", ""], ["", "", "", "デザイン・バックキャスティン...", "デザイン・バックキャスティン...", "", ""], ["", "", "プロジェクト実習・制作２", "プロジェクト実習・制作２", "デザインケーススタディ", "", ""], ["", "情報システムデザイン", "ＡＩプログラミング", "ＡＩプログラミング", "", "", ""], ["", "", "", "", "", "", ""], ["", "", "", "", "", "", ""]])
}
